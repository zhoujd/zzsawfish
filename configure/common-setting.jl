...
(setq apps-menu  
      `((,(_ "_Terminal		e,t")   (system "gnome-terminal &"))  
        (,(_ "_Emacs  		e,e")   (system "emacs &"))  
        (,(_ "_Firefox		e,f")   (system "firefox &"))  
        (,(_ "_Bcompare		e,b")   (system "bcompare &"))
        (,(_ "_Nautilus		e,n")   (system "nautilus --no-desktop ~ &"))
        (,(_ "_Remmina		e,r")   (system "remmina &"))
        (,(_ "_Evince  		e,C-e") (system "evince &"))
        (,(_ "_Monitor		e,m")   (system "gnome-system-monitor &"))
        (,(_ "_Tool")
         (,(_ "_Gcolor2		")      (system "gcolor2 &"))  
         (,(_ "_Gcalctool	")      (system "gcalctool &")))
        (,(_ "_Capture")
         (,(_ "Current Window")     (capture-this-window))  
         (,(_ "Region")             (capture-region))  
         (,(_ "Full Screen")        (capture-root-window)))
        ()
        (,(_ "_Run			e,F2")  (system "gmrun &"))
        (,(_ "_Lock			l")     (system "xscreensaver-command -lock &"))
        ))
